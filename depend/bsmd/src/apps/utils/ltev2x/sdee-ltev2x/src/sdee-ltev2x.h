/** 
 * @file
 * @brief sdee-lte-v2x 샘플 어플리케이션 메인 헤더 파일
 * @date 2021-02-25
 * @author gyun
 */


#ifndef V2X_SW_SDEE_LTEV2X_H
#define V2X_SW_SDEE_LTEV2X_H
...
struct MIB
{
  ...
  LTEV2XHALTxFlowType tx_flow_type; ///< 송신플로우 유형
