...
enum eDot3WSMPayloadSize
{
  ...
  kDot3WSMPayloadSize_Max = (4200 - kDot3WSMHdrSize_Max), ///< 최대길이 (=최대LSDU 길이 - 최대WSM헤더길이)
};
...
enum eDot3WSMSize
{
  ...
  kDot3WSMSize_Max = (4202 - 2), ///< 최대길이 (= 최대MSDU길이 - LLC헤더길이) (per 802.11)
};
...
enum eDot3MPDUSize
{
  ...
  kDot3MPDUSize_Max = (26 + 4202), ///< 최대길이 (= MAC헤더길이 + 최대MSDU길이, CRC는 제외) (per 802.11)
};
