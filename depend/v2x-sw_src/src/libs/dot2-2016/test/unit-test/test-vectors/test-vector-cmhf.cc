 ...
 */
const char *g_tv_cmhf_issuer = "";
int g_tv_cmhf_issuer_size = 219;
const char *g_tv_cmhf_issuer_h = "4f6e03271b2b76721ecfb7bac3e2ff114176dc9ac42023f0d2ebc6a2ce83fc16";
...
rec1value CertificateBase ::= {
  version 3,
  type implicit,
  issuer sha256AndDigest : 'D2EBC6A2CE83FC16'H,
  toBeSigned {
    id binaryId : 'CE0A22C1097C03DB'H,
    cracaId 'D2776C'H,
    crlSeries 3,
    validityPeriod {
      start 581219906,
    ...
    verifyKeyIndicator reconstructionValue : compressed-y-1 : '30CE8C5C4AEB8C0F9130F18013084C96CE90FE3CEE52D979C48EEFB0E37156D9'H
  }
}
 */
const char *g_tv_cmhf_app_cert_0 = "00030180d2ebc6a2ce83fc16508208ce0a22c1097c03dbd2776c000322a4b6428400a983010180019a0103000120000123000187818330ce8c5c4aeb8c0f9130f18013084c96ce90fe3cee52d979c48eefb0e37156d9";
int g_tv_cmhf_app_cert_size_0 = 86;
const char *g_tv_cmhf_app_cert_init_priv_key_0 = "348C78C80138790023F65B467180380CF0749F8CB28F6EF4524222D5E940F067";
const char *g_tv_cmhf_app_cert_recon_priv_0 = "EE89D423963A9AA60D88249DDA0F99241637C0B5C7C599E16EBA01484D102E75";
const char *g_tv_cmhf_app_cert_priv_key_0 = "E32A6506DFBCEA1D7B27706F9EA75B86E4C18C0FED6F5F5519CCF7862A242960";
const char *g_tv_cmhf_app_cert_key_cmhf_name_0 = "";
uint8_t g_tv_cmhf_app_cert_key_cmhf_0 = {

};
int g_tv_cmhf_app_cert_key_cmhf_size_0 = 3;


#if 0
g_sample_rse_0_key_cmhf_name[] = "135_191030.130308-191204.230308_key.cmhf";
...
char g_sample_rse_0_key_cmhf_name[] = "135_191030.130308-191204.230308_key.cmhf";
uint8_t g_sample_rse_0_cmhf[] = {
0x49, 0x54, 0x45, 0x4B, // magic_number1
0x00, // cmh_type = seq
0x01, // psid_num
0x01, // valid_region_present
0x00, // valid_region_type = circular
0x1D, 0xC6, 0x27, 0x0C, // valid start
0x1D, 0xF4, 0xD8, 0x2C, // valid end
0x95, 0xB1, 0xBD, 0x1F, 0xB5, 0x95, 0x23, 0x57, 0x1C, 0x61, 0xE7, 0x28, 0x7F, 0x15, 0x3A, 0x83,
0xF6, 0x39, 0x5E, 0x9F, 0x74, 0x11, 0xD7, 0x8A, 0xB6, 0x8C, 0xE8, 0x9C, 0x75, 0x39, 0x68, 0x49, // 인증서 해시
0x16, 0x3F, 0x2B, 0x7B, 0xC9, 0x92, 0x53, 0xF4, // 상위인증서 h8
0x04, 0x87, 0x7F, 0xD3, 0x17, 0x1A, 0x4E, 0x54, 0xAA, 0x51, 0xF6, 0x96, 0x31, 0xD2, 0xFA, 0xF3, 0x45,
0x79, 0x51, 0x89, 0x48, 0x79, 0x75, 0x71, 0x58, 0xCA, 0xE5, 0xB1, 0x48, 0xBB, 0x00, 0x1A, 0xA6,
0x4E, 0x86, 0xF3, 0xC5, 0x92, 0x37, 0x4E, 0xF1, 0xFF, 0x4A, 0x5E, 0xE3, 0xDE, 0x12, 0x6B, 0x6C,
0xC8, 0xED, 0xE4, 0x28, 0xC1, 0x09, 0xEB, 0x66, 0xAB, 0x81, 0x47, 0xB7, 0xDD, 0xBF, 0x95, 0x30, // 공개키
0x00, // 개인키 유형 = 키
0x00, 0x55, // 인증서 데이터 크기
0x39, 0x38, 0x14, 0xEB, // magic_number2
0xE3, 0x2A, 0x65, 0x06, 0xDF, 0xBC, 0xEA, 0x1D, 0x7B, 0x27, 0x70, 0x6F, 0x9E, 0xA7, 0x5B, 0x86,
0xE4, 0xC1, 0x8C, 0x0F, 0xED, 0x6F, 0x5F, 0x55, 0x19, 0xCC, 0xF7, 0x86, 0x2A, 0x24, 0x29, 0x60, // 개인키
0x00, 0x00, 0x00, 0x87, // Psid
0x16, 0x57, 0xD9, 0xD6, // center.lat
0x4B, 0xB8, 0xA7, 0xFE, // center.lon
0x0B, 0xB8, // radius
...
char g_sample_rse_1_key_cmhf_name[] = "135_191204.230308-200109.090308_key.cmhf";
...
0x01, // valid_region_present
0x00, // valid_region_type = circular
0x1D, 0xF4, 0xD8, 0x2C, // valid start
0x1E, 0x23, 0x89, 0x4C, // valid end
0x15, 0x89, 0xDA, 0xDC, 0x6D, 0xB1, 0xC2, 0x14, 0x5D, 0x03, 0xBC, 0x69, 0xBB, 0xCE, 0xE6, 0xFB,
0xF0, 0xA7, 0x4B, 0xBD, 0xC9, 0x3D, 0x51, 0xDD, 0x96, 0xD4, 0x02, 0xAA, 0x72, 0xFD, 0x89, 0x69, // 인증서 해시
0x16, 0x3F, 0x2B, 0x7B, 0xC9, 0x92, 0x53, 0xF4, // 상위인증서 h8
0x04, 0xA4, 0x4B, 0x71, 0xE0, 0x60, 0x2B, 0xA2, 0x2F, 0xB0, 0x4B, 0x88, 0x17, 0xC2, 0xEF, 0xE7,
0xF2, 0x40, 0x10, 0x54, 0x44, 0x25, 0xA4, 0x10, 0xB1, 0x72, 0x3B, 0xE7, 0x3D, 0x6F, 0xF6, 0x8A,
0xBB, 0x87, 0x85, 0x82, 0x6C, 0x92, 0x86, 0xBC, 0x90, 0x26, 0x15, 0x2E, 0xA6, 0xF3, 0x86, 0x9D,
0xF3, 0xB4, 0x41, 0xD0, 0x2F, 0x25, 0x97, 0xBD, 0xF0, 0xDF, 0xC8, 0xF6, 0x4B, 0xB8, 0xFA, 0xB1, 0xA2, // 공개키
0x00, // 개인키 유형 = 키
0x00, 0x55, // 인증서 데이터 크기
0x39, 0x38, 0x14, 0xEB, // magic_number2
0x7D, 0x10, 0x68, 0xB7, 0xFA, 0xDC, 0x2E, 0xD5, 0x1E, 0x6C, 0xCC, 0x90, 0x2E, 0x36, 0xCE, 0x2E,
0x89, 0xDF, 0xBC, 0x30, 0xC6, 0xFF, 0x3E, 0xE7, 0x5C, 0x92, 0x74, 0xA9, 0x09, 0x65, 0x97, 0x63, // 개인키
0x00, 0x00, 0x00, 0x87, // Psid
0x16, 0x57, 0xD9, 0xD6, // center.lat
0x4B, 0xB8, 0xA7, 0xFE, // center.lon
0x0B, 0xB8, // radius
...
char g_sample_rse_2_key_cmhf_name[] = "135_200109.090308-200213.190308_key.cmhf";
...
0x01, // valid_region_present
0x00, // valid_region_type = circular
0x1E, 0x23, 0x89, 0x4C, // valid start
0x1E, 0x52, 0x3A, 0x6C, // valid end
0x88, 0xF3, 0x53, 0x11, 0xEA, 0x8B, 0x4D, 0x7F, 0x75, 0x34, 0x76, 0x76, 0xEB, 0xC3, 0x6E, 0x17,
0xBC, 0x82, 0x2F, 0xBF, 0xC8, 0x6B, 0xE7, 0xD7, 0xE2, 0x44, 0x8D, 0x58, 0xB3, 0x42, 0xBF, 0x8A, // 인증서 해시
0x16, 0x3F, 0x2B, 0x7B, 0xC9, 0x92, 0x53, 0xF4, // 상위인증서 h8
0x04, 0x0B, 0x4B, 0x90, 0x2D, 0xCD, 0xD3, 0xEE, 0x45, 0x82, 0x40, 0x36, 0xA4, 0xDD, 0x87, 0xE8, 0xCB,
0x0B, 0x4B, 0x11, 0x69, 0xB0, 0xB3, 0x26, 0x11, 0x9F, 0x41, 0xB0, 0xE7, 0xCE, 0xCD, 0xDC, 0x19,
0x1B, 0xBD, 0x98, 0x51, 0x5D, 0xD3, 0x52, 0x56, 0x63, 0x82, 0xB6, 0x2C, 0xF2, 0x15, 0x5E, 0x53,
0x95, 0x0D, 0xAD, 0x60, 0xBB, 0x92, 0xAE, 0x2E, 0x77, 0xD7, 0xA5, 0xA3, 0x9C, 0x40, 0xF1, 0x00, // 공개키
0x00, // 개인키 유형 = 키
0x00, 0x55, // 인증서 데이터 크기
0x39, 0x38, 0x14, 0xEB, // magic_number2
0xDF, 0x28, 0xD8, 0xDA, 0x1D, 0x14, 0x19, 0x5D, 0x21, 0x0B, 0xF2, 0x47, 0x90, 0x6B, 0xA3, 0x17,
0x34, 0x2B, 0x9D, 0x17, 0x4E, 0x2F, 0x09, 0xA8, 0x19, 0x9E, 0x6C, 0x1A, 0x6D, 0x00, 0x7A, 0x6F, // 개인키
0x00, 0x00, 0x00, 0x87, // Psid
0x16, 0x57, 0xD9, 0xD6, // center.lat
0x4B, 0xB8, 0xA7, 0xFE, // center.lon
0x0B, 0xB8, // radius
...
char g_sample_rse_3_key_cmhf_name[] = "135_200213.190308-200320.050308_key.cmhf";
...
0x01, // valid_region_present
0x00, // valid_region_type = circular
0x1E, 0x52, 0x3A, 0x6C, // valid start
0x1E, 0x80, 0xEB, 0x8C, // valid end
0x9B, 0xAF, 0x40, 0x23, 0x39, 0xE7, 0x6C, 0xF1, 0x23, 0xAA, 0x40, 0xB2, 0x70, 0x6E, 0x0B, 0xF0,
0x13, 0x05, 0x4A, 0x39, 0xE6, 0x65, 0x36, 0x93, 0xFE, 0x27, 0x55, 0x97, 0x2F, 0x92, 0x62, 0xBC, // 인증서 해시
0x16, 0x3F, 0x2B, 0x7B, 0xC9, 0x92, 0x53, 0xF4, // 상위인증서 h8
0x04, 0x7F, 0x20, 0x32, 0x06, 0x16, 0xAC, 0xEE, 0x95, 0x4E, 0x9B, 0x3E, 0x48, 0x58, 0xD2, 0x05, 0x24,
0xA4, 0xA5, 0x25, 0xFA, 0xFD, 0x7C, 0x62, 0x0B, 0x75, 0x16, 0xA9, 0xBA, 0x66, 0x55, 0x8D, 0xE9,
0x95, 0x19, 0x47, 0xCF, 0x7E, 0xC1, 0x0D, 0x95, 0x2F, 0xBA, 0x79, 0x6D, 0x94, 0xD8, 0x0F, 0xC7,
0x99, 0x04, 0x45, 0xF7, 0x4F, 0x2D, 0x96, 0x64, 0x56, 0x69, 0xC1, 0x03, 0x8B, 0xC3, 0x79, 0x39, // 공개키
0x00, // 개인키 유형 = 키
0x00, 0x55, // 인증서 데이터 크기
0x39, 0x38, 0x14, 0xEB, // magic_number2
0x1C, 0x62, 0xDA, 0xBC, 0xED, 0x99, 0x15, 0x30, 0xF6, 0xE7, 0x17, 0x5A, 0x35, 0xFE, 0xB5, 0x23,
0x5D, 0xF1, 0x49, 0x10, 0xC2, 0x12, 0x49, 0xF8, 0x9C, 0x78, 0xA9, 0xF8, 0x0A, 0xB0, 0xFF, 0xF3, // 개인키
0x00, 0x00, 0x00, 0x87, // Psid
0x16, 0x57, 0xD9, 0xD6, // center.lat
0x4B, 0xB8, 0xA7, 0xFE, // center.lon
0x0B, 0xB8, // radius
...
char g_sample_rse_4_key_cmhf_name[] = "135_200320.050308-200424.150308_key.cmhf";
...
0x01, // valid_region_present
0x00, // valid_region_type = circular
0x1E, 0x80, 0xEB, 0x8C, // valid start
0x1E, 0xAF, 0x9C, 0xAC, // valid end
0x9C, 0x36, 0x62, 0x26, 0x4F, 0xEC, 0x09, 0x81, 0x2F, 0xD7, 0x25, 0x86, 0xE4, 0xA7, 0x86, 0x13,
0x3F, 0xF5, 0x31, 0x97, 0x4C, 0xD5, 0x36, 0xE3, 0xF0, 0x1D, 0x5A, 0x94, 0x3C, 0x74, 0xA7, 0x7A, // 인증서 해시
0x16, 0x3F, 0x2B, 0x7B, 0xC9, 0x92, 0x53, 0xF4, // 상위인증서 h8
0x04, 0x46, 0xA2, 0x17, 0x93, 0xDB, 0x80, 0x76, 0x29, 0x5E, 0xC6, 0xB6, 0xD7, 0x22, 0xAB, 0xBD, 0xF1,
0x7F, 0xC4, 0x32, 0xF0, 0x2C, 0xA1, 0xD4, 0x11, 0x2A, 0xAC, 0x86, 0xDD, 0xB8, 0xDC, 0x9C, 0x4D,
0x33, 0xE9, 0x8F, 0x28, 0xFE, 0xAF, 0xFF, 0xA1, 0x54, 0x6A, 0xBF, 0x67, 0x9F, 0x19, 0x15, 0xDC,
0x99, 0x66, 0x4D, 0xC1, 0x1E, 0xC5, 0xF0, 0x0C, 0xC5, 0x8F, 0x34, 0x94, 0x18, 0xD4, 0x35, 0xB4, // 공개키
0x00, // 개인키 유형 = 키
0x00, 0x55, // 인증서 데이터 크기
0x39, 0x38, 0x14, 0xEB, // magic_number2
0xE2, 0xEC, 0xCE, 0x40, 0xCB, 0xB8, 0x43, 0x49, 0xC0, 0x15, 0xE5, 0x77, 0x9C, 0x1C, 0x5E, 0x58,
0x9A, 0xC0, 0xA0, 0x7C, 0xBF, 0x19, 0xEE, 0xEB, 0x69, 0x4A, 0x51, 0x62, 0x3A, 0xAA, 0x32, 0xED, // 개인키
0x00, 0x00, 0x00, 0x87, // Psid
0x16, 0x57, 0xD9, 0xD6, // center.lat
0x4B, 0xB8, 0xA7, 0xFE, // center.lon
0x0B, 0xB8, // radius
