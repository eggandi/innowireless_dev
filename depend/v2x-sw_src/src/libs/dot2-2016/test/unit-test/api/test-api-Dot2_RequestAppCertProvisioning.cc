/**
  * @file
  * @brief Dot2_RequestAppCertProvisioning() API 단위테스트
  * @date 2023-02-27
  * @author gyun
  */
 ...
 * @brief 기본동작 테스트
 */
TEST(Dot2_RequestAppCertProvisioning, NORMAL)
{
  ...
  Dot2Time32 cert_dl_time = g_tv_bluetech_app_cert_prov_resp_cert_dl_time;
   ...
   */
  {
    ...
    // LCM 설정
    ASSERT_EQ(Dot2_ConfigLCM(kDot2LCMConfigType_AppCertProvisioningReqURL, g_tv_bluetech_app_cert_req_url), kDot2Result_Success);
    ...
    // 라이브러리 내부 테스트벡터 설정
    ASSERT_EQ(Dot2Test_ConvertHexStrToOctets(g_tv_bluetech_app_cert_prov_req_initial_verify_key_priv, g_dot2_mib.lcm.test.app_cert.tv.verify_key.priv_key.octs), DOT2_EC_256_KEY_LEN);
    ASSERT_EQ(Dot2Test_ConvertHexStrToOctets(g_tv_bluetech_app_cert_prov_req_initial_verify_key_pub, g_dot2_mib.lcm.test.app_cert.tv.verify_key.pub_key.u.octs), DOT2_EC_256_POINT_LEN);
    ASSERT_EQ(Dot2Test_ConvertHexStrToOctets(g_tv_bluetech_app_cert_prov_req_encryption_key_priv, g_dot2_mib.lcm.test.app_cert.tv.encryption_key.priv_key.octs), DOT2_EC_256_KEY_LEN);
    ASSERT_EQ(Dot2Test_ConvertHexStrToOctets(g_tv_bluetech_app_cert_prov_req_encryption_key_pub, g_dot2_mib.lcm.test.app_cert.tv.encryption_key.pub_key.u.octs), DOT2_EC_256_POINT_LEN);
    ASSERT_EQ(g_dot2_mib.lcm.test.app_cert.tv.provisioning_req_size = Dot2Test_ConvertHexStrToOctets(g_tv_bluetech_app_cert_prov_req, g_dot2_mib.lcm.test.app_cert.tv.provisioning_req), g_tv_bluetech_app_cert_prov_req_size);
    ASSERT_EQ(Dot2Test_ConvertHexStrToOctets(g_tv_bluetech_app_cert_prov_req_h8, g_dot2_mib.lcm.test.app_cert.tv.provisioning_req_h8), 8);
    ASSERT_EQ(g_dot2_mib.lcm.test.https_resp_tv.resp_size = Dot2Test_ConvertHexStrToOctets(g_tv_bluetech_app_cert_prov_resp, g_dot2_mib.lcm.test.https_resp_tv.resp), g_tv_bluetech_app_cert_prov_resp_size);
   ...
   */
  {
    ...
    ASSERT_TRUE(Dot2Test_CompareOctets(res.common.req_h8, g_dot2_mib.lcm.test.app_cert.tv.provisioning_req_h8, 8));
    ASSERT_TRUE(Dot2Test_CompareOctets(res.common.verify_priv_key.octs, g_dot2_mib.lcm.test.app_cert.tv.verify_key.priv_key.octs, DOT2_EC_256_KEY_LEN));
    ASSERT_TRUE(Dot2Test_CompareOctets(res.common.cert_enc_priv_key.octs, g_dot2_mib.lcm.test.app_cert.tv.encryption_key.priv_key.octs, DOT2_EC_256_KEY_LEN));
   ...
   */
  {
    ...
    ASSERT_EQ(res.options.req_size, 0u);
    ASSERT_EQ(res.options.ack_size, 0u);
 ...
 */
TEST(Dot2_RequestAppCertProvisioning, INVALID_PARAMS)
{
  ASSERT_EQ(Dot2_Init(kDot2LogLevel_Err, kDot2SigningParamsPrecomputeInterval_Default, "/dev/urandom", kDot2LeapSeconds_Default), kDot2Result_Success);
   ...
   */
  {
    ...
    params.current_time = 0;
    params.start_time = 0;
    res = Dot2_RequestAppCertProvisioning(nullptr);
 ...
 * @brief LCM 설정이 되지 않음
 */
TEST(Dot2_RequestAppCertProvisioning, NO_LCM_CONFIG)
{
  ASSERT_EQ(Dot2_Init(kDot2LogLevel_Err, kDot2SigningParamsPrecomputeInterval_Default, "/dev/urandom", kDot2LeapSeconds_Default), kDot2Result_Success);
 ...
 */
TEST(Dot2_RequestAppCertProvisioning, NO_ENROL_CMHF)
{
  ASSERT_EQ(Dot2_Init(kDot2LogLevel_Err, kDot2SigningParamsPrecomputeInterval_Default, "/dev/urandom", kDot2LeapSeconds_Default), kDot2Result_Success);
 ...
 */
TEST(Dot2_RequestAppCertProvisioning, NO_PCA_CERT)
{
  ASSERT_EQ(Dot2_Init(kDot2LogLevel_Err, kDot2SigningParamsPrecomputeInterval_Default, "/dev/urandom", kDot2LeapSeconds_Default), kDot2Result_Success);
 ...
 */
TEST(Dot2_RequestAppCertProvisioning, NO_RA_CERT)
{
  ASSERT_EQ(Dot2_Init(kDot2LogLevel_Err, kDot2SigningParamsPrecomputeInterval_Default, "/dev/urandom", kDot2LeapSeconds_Default), kDot2Result_Success);
 ...
 */
TEST(Dot2_RequestAppCertProvisioning, INVALID_ACK_MSG)
{
  ASSERT_EQ(Dot2_Init(kDot2LogLevel_Err, kDot2SigningParamsPrecomputeInterval_Default, "/dev/urandom", kDot2LeapSeconds_Default), kDot2Result_Success);
   ...
   */
  {
    ...
    g_dot2_mib.lcm.test.app_cert.tv.provisioning_req_h8[0]++;
    params.return_options = true;
    params.current_time = 0;
    params.start_time = 0;
    res = Dot2_RequestAppCertProvisioning(&params);
    ...
    ASSERT_FALSE(res.options.req);
    ASSERT_FALSE(res.options.ack);
    g_dot2_mib.lcm.test.app_cert.tv.provisioning_req_h8[0]--; // 원상복구
 ...
 * @brief 응답문 수신 오류
 */
TEST(Dot2_RequestAppCertProvisioning, ACK_MSG_RX_ERROR)
{
  ASSERT_EQ(Dot2_Init(kDot2LogLevel_Err, kDot2SigningParamsPrecomputeInterval_Default, "/dev/urandom", kDot2LeapSeconds_Default), kDot2Result_Success);
