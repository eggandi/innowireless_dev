/**
  * @file
  * @brief Dot2_RequestIdCertProvisioning() API 단위테스트
  * @date 2023-03-06
  * @author gyun
  */
 ...
 * @brief 기본동작 테스트
 */
TEST(Dot2_RequestIdCertProvisioning, NORMAL)
{
   ...
   */
  {
    ...
    // LCM 설정
    ASSERT_EQ(Dot2_ConfigLCM(kDot2LCMConfigType_IdCertProvisioningReqURL, g_tv_bluetech_id_cert_req_url), kDot2Result_Success);
   ...
   */
  {
    ...
    ASSERT_TRUE(Dot2Test_CompareOctets(res.common.req_h8, g_dot2_mib.lcm.test.id_cert.tv.prov_req_h8, 8));
    ASSERT_TRUE(Dot2Test_CompareOctets(res.common.verify_priv_key.octs, g_dot2_mib.lcm.test.id_cert.tv.verify_key.priv_key.octs, DOT2_EC_256_KEY_LEN));
    ASSERT_TRUE(Dot2Test_CompareOctets(res.common.cert_enc_priv_key.octs, g_dot2_mib.lcm.test.id_cert.tv.encryption_key.priv_key.octs, DOT2_EC_256_KEY_LEN));
    ASSERT_TRUE(Dot2Test_CompareOctets(res.verify_exp_key.octs, g_dot2_mib.lcm.test.id_cert.tv.verify_exp_key.octs, DOT2_AES_128_LEN));
    ASSERT_TRUE(Dot2Test_CompareOctets(res.cert_enc_exp_key.octs, g_dot2_mib.lcm.test.id_cert.tv.encryption_exp_key.octs, DOT2_AES_128_LEN));
 ...
 */
TEST(Dot2_RequestIdCertProvisioning, INVALID_PARAMS)
{
  ASSERT_EQ(Dot2_Init(kDot2LogLevel_Err, kDot2SigningParamsPrecomputeInterval_Default, "/dev/urandom", kDot2LeapSeconds_Default), kDot2Result_Success);
   ...
   */
  {
    ...
    ASSERT_EQ(Dot2Test_ConvertHexStrToOctets(g_tv_bluetech_id_cert_prov_req_encryption_key_exp, enc_exp_key.octs), DOT2_AES_128_LEN);
    strcpy(req_filename, g_tv_bluetech_id_cert_down_req_filename_0);
    strcpy(pc_cmhf_name, g_tv_bluetech_id_cert_down_cmhf_name_0);
    strcpy(down_dirname, g_tv_bluetech_id_cert_down_dir_name_0);
    strcpy(cert_filename, g_tv_bluetech_id_cert_down_0.cert_filename);
    strcpy(priv_key_filename, g_tv_bluetech_id_cert_down_0.priv_key_filename);
    strcpy(recon_priv_filename, g_tv_bluetech_id_cert_down_0.recon_priv_filename);
    ...
    ASSERT_EQ(prov_resp_size = Dot2Test_ConvertHexStrToOctets(g_tv_bluetech_id_cert_prov_resp, prov_resp), g_tv_bluetech_id_cert_prov_resp_size);
    ASSERT_EQ(zipfile_size = Dot2Test_ConvertHexStrToOctets(g_tv_bluetech_id_cert_down_zipfile_0, zipfile), g_tv_bluetech_id_cert_down_zipfile_size_0);
    ASSERT_EQ(pc_cmhf_size = Dot2Test_ConvertHexStrToOctets(g_tv_bluetech_id_cert_down_cmhf_0, pc_cmhf), g_tv_bluetech_id_cert_down_cmhf_size_0);
   ...
   */
  {
    ...
    params.current_time = 0;
    params.start_time = 0;
    res = Dot2_RequestIdCertProvisioning(nullptr);
 ...
 * @brief LCM 설정이 되지 않음
 */
TEST(Dot2_RequestIdCertProvisioning, NO_LCM_CONFIG)
{
  ASSERT_EQ(Dot2_Init(kDot2LogLevel_Err, kDot2SigningParamsPrecomputeInterval_Default, "/dev/urandom", kDot2LeapSeconds_Default), kDot2Result_Success);
 ...
 */
TEST(Dot2_RequestIdCertProvisioning, NO_ENROL_CMHF)
{
  ASSERT_EQ(Dot2_Init(kDot2LogLevel_Err, kDot2SigningParamsPrecomputeInterval_Default, "/dev/urandom", kDot2LeapSeconds_Default), kDot2Result_Success);
 ...
 */
TEST(Dot2_RequestIdCertProvisioning, NO_PCA_CERT)
{
  ASSERT_EQ(Dot2_Init(kDot2LogLevel_Err, kDot2SigningParamsPrecomputeInterval_Default, "/dev/urandom", kDot2LeapSeconds_Default), kDot2Result_Success);
 ...
 */
TEST(Dot2_RequestIdCertProvisioning, NO_RA_CERT)
{
  ASSERT_EQ(Dot2_Init(kDot2LogLevel_Err, kDot2SigningParamsPrecomputeInterval_Default, "/dev/urandom", kDot2LeapSeconds_Default), kDot2Result_Success);
 ...
 */
TEST(Dot2_RequestIdCertProvisioning, INVALID_ACK_MSG)
{
  ASSERT_EQ(Dot2_Init(kDot2LogLevel_Err, kDot2SigningParamsPrecomputeInterval_Default, "/dev/urandom", kDot2LeapSeconds_Default), kDot2Result_Success);
   ...
   */
  {
    ...
    g_dot2_mib.lcm.test.id_cert.tv.prov_req_h8[0]++;
    res = Dot2_RequestIdCertProvisioning(&params);
    ASSERT_EQ(res.ret, -kDot2Result_LCM_DifferentCertProvisioningAckRequestHash);
    ASSERT_FALSE(res.common.cert_dl_url);
    ASSERT_FALSE(res.options.req);
    ASSERT_FALSE(res.options.ack);
    g_dot2_mib.lcm.test.id_cert.tv.prov_req_h8[0]--; // 원상복구
 ...
 * @brief 응답문 수신 오류
 */
TEST(Dot2_RequestIdCertProvisioning, ACK_MSG_RX_ERROR)
{
  ASSERT_EQ(Dot2_Init(kDot2LogLevel_Err, kDot2SigningParamsPrecomputeInterval_Default, "/dev/urandom", kDot2LeapSeconds_Default), kDot2Result_Success);
