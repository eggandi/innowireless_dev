...
/**
 * @brief 식별인증서 발급요청문 내 EeRaIdCertProvisioningRequest 필드를 채운다.
 * @param[in] current_time 현재시각
 * @param[in] start_time 식별인증서 유효기간 시작시점
 ...
 */
int INTERNAL dot2_ffasn1c_FillEeRaIdCertProvisioningRequest(
  ...
  dot2EeRaIdCertProvisioningRequest *asn1_req)
{
  Log(kDot2LogLevel_Event, "Fill EeRaIdCertProvisioningRequest\n");
