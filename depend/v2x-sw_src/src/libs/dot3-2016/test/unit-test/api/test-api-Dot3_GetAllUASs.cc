/** 
 * @file
 * @brief Dot3_GetAllUASs() API에 대한 단위테스트 구현 파일
 * @date 2020-07-29
 * @author gyun
 */
...
/**
 * @brief Dot3_GetAllUASs() API 호출 시 해당되는 UAS들이 정상적으로 반한되는 것을 확인한다.
 */
TEST(Dot3_GetAllUASs, NORMAL)
{
  InitTestEnv();
...
/**
 * @brief Dot3_GetAllUASs() API 호출 시 USR이 없어 UAS 테이블에 UAS가 하나도 없을 때의 동작을 확인한다.
 */
TEST(Dot3_GetAllUASs, NO_UAS_WITH_NO_USR)
{
  InitTestEnv();
...
/**
 * @brief Dot3_GetAllUASs() API 호출 시 WSA가 수신되지 않아 UAS 테이블에 UAS가 하나도 없을 때의 동작을 확인한다.
 */
TEST(Dot3_GetAllUASs, NO_UAS_WITH_NO_WSA_RX)
{
  InitTestEnv();
...
/**
 * @brief Dot3_GetAllUASs() API 호출 시 NULL 파라미터 전달에 따른 동작을 확인한다.
 */
TEST(Dot3_GetAllUASs, CHECK_PARAMS_NULL)
{
  InitTestEnv();
